...
public class AdapterDelegate {
        ...
        static {
                ...
                try{
                        Class c = AdapterDelegate.class;
                        Object o = c.getClassLoader().getResourceAsStream("adapter.properties");
        ...
        public AdapterDelegate() {
                ...
                // use specified InputFactory to guarantee XmlMapper works in both Spring framework and WAS
        ...
        public String toString(Object obj) {
                ...
                Object repObj = getReportObject(obj);
                if(repObj == null) {
                        repObj = obj;
                }
                if(xml) {
        ...
        public Object getReportObject(Object obj) {
